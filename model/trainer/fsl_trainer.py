...
from model.trainer.helpers import examplar_collate
import os
...
class FSLTrainer(Trainer):
    ...
    def train(self):
        ...
        paddle.save(self.trlog, osp.join(args.save_path, 'trlog'))
    ...
    def evaluate(self, data_loader):
        ...
        label = paddle.arange(args.eval_way, dtype=paddle.int16).repeat(
            # args.num_tasks *
            args.eval_query)
        label = label.long()
        if len(fluid.cuda_places()) > 0:
    ...
    def test_process(self, testset):
        ...
        # b_sampler = BatchSampler(sampler=test_sampler)
        ...
        label = paddle.tile(paddle.arange(args.eval_way, dtype=paddle.int64), (args.eval_query,))
